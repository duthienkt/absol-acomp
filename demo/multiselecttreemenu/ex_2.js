                            ...
                            },
                            {
                                ...
                                items: [
                                    ...
                                    },
                                    {
                                        ...
                                        sortText: "mien trung - cao nguyen",
                                        noSelect: false
                                    },
                                    {
                                        value: -53,
...
function makeNoSelect(item){
    // if (item.isLeaf) item.noSelect = true;
    if (item.isLeaf) item.isLeaf = false;
    if (item.items) item.items.forEach(it=> makeNoSelect(it));
}

makeNoSelect(items[0])
